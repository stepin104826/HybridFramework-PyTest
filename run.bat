...
pytest -v -s -m "smoke" -n=2 --html=./Reports/report_firefox.html testCases/ --browser firefox
pytest -v -s -m "smoke" -n=2 --html=./Reports/report_edge.html testCases/ --browser edge
